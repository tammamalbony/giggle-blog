...
<div class="col-md-4 col-sm-12">
    <div class="card mb-3">
        <div class="row g-0 position-relative">
            ...
            <div class="card-body "
               >
                <h5 class="card-title clickable-card"  data-link="<?php echo $this->createUrl('view', array('id' => $data->id)); ?>"><?php echo CHtml::encode($data->title); ?></h5>
                <p class="card-text clickable-card"  data-link="<?php echo $this->createUrl('view', array('id' => $data->id)); ?>">
                ...
                <p class="card-text clickable-card"  data-link="<?php echo $this->createUrl('view', array('id' => $data->id)); ?>"><?php echo CHtml::encode($data->description); ?></p>
                <div class="d-flex justify-content-between clickable-card"  data-link="<?php echo $this->createUrl('view', array('id' => $data->id)); ?>">
                    <div class="d-flex">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="clickable-card"  data-link="<?php echo $this->createUrl('view', array('id' => $data->id)); ?>">
                        <strong>Comments:
