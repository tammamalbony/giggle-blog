...
<div class="container-fluid controls_filters" style="margin-top: 50px;">
    ...
    <div class="row">
        ...
        <div class="d-flex justify-content-end my-1 max-w-100vw">
            <form action="<?php echo Yii::app()->createUrl('blogPost/myPosts'); ?>" method="GET"
                ...
                <div class="row">
                    ...
                    <div class="col-custom">
                        ...
                        <div class="d-none d-md-flex">
                            ...
                            <a href="<?php echo Yii::app()->createUrl('blogPost/myPosts'); ?>"
    ...
    <?php $this->widget(
        ...
        array(
            ...
            'itemView' => '_viewwithcontrol', // Use the view with controls
